...
const slides = [
  ...
  function showSlide(index) {
    ...
    // Reload and play the audio automatically (optional)
    slideshowAudio.load();
    // slideshowAudio.play(); // uncomment if you want auto-play
  }
